...
export default function AboutContact() {
  ...
  return (
    <section id="sobre" className="py-24 px-6 relative overflow-hidden bg-[#FAF6F4]">
      {/* Decorative leaf/flourish background shape */}
      <div className="absolute top-1/2 left-[-10%] w-[30vw] h-[40vw] max-w-sm bg-[#E5D5CE] opacity-30 rounded-full blur-2xl z-0 pointer-events-none transform -translate-y-1/2" />
        ...
        <div className="flex flex-col lg:flex-row gap-16 lg:gap-24 items-center">
          ...
          >
            <div className="relative w-[320px] h-[420px] md:w-[400px] md:h-[500px] z-10">
              <div className="absolute inset-0 organic-shape bg-white shadow-2xl shadow-[#E5D5CE]/50 overflow-hidden border-8 border-white p-2 flex items-center justify-center">
                 <div className="w-full h-full organic-shape bg-[#F4E3E2] flex items-center justify-center relative overflow-hidden">
                    <Image 
                      src="/images/duda.png"
          ...
          >
            ...
            <motion.p variants={textVariants} className="text-lg text-[#7A6B62] font-sans leading-relaxed mb-6">
            ...
            <motion.p variants={textVariants} className="text-lg text-[#7A6B62] font-sans leading-relaxed mb-10">
            ...
            {/* Contact Info */}
            <motion.div variants={textVariants} className="w-full bg-white p-8 rounded-3xl shadow-xl shadow-[#F5F0EE]/80 border border-[#F5F0EE] flex flex-col gap-6 hover:shadow-2xl hover:shadow-[#F0D3D3]/40 transition-shadow duration-500">
              <h3 className="font-serif text-2xl text-[var(--foreground)] border-b border-[#F5F0EE] pb-4">
                Fale Comigo
              </h3>
              
              <ul className="flex flex-col gap-4 text-left">
                <li className="flex items-center gap-4 text-[#7A6B62]">
                  <div className="w-10 h-10 shrink-0 rounded-full bg-[#FDF9F7] flex items-center justify-center text-[var(--accent)]">
